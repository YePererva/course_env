# Version control + Publishing to GitHub pages 
...
Example of such project cold be [Digital Garden](https://github.com/jobindjohn/obsidian-publish-mkdocs/tree/main)

Free Hosting for static pages for personal use:
